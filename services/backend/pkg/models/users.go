...
type Users struct {
	...
	OIDCProvider       string    `bun:"oidc_provider,type:text,default:''" json:"oidc_provider"`                 // e.g., "google", "github", "keycloak"
	OIDCProviderUserID string    `bun:"oidc_provider_user_id,type:text,default:''" json:"oidc_provider_user_id"` // Provider's unique ID for the user (sub claim)
